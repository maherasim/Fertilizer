...
<div class="card-agri">
  <div class="card-header">Add Fertilizer</div>
  <div class="card-body">
    <form method="POST" class="form-grid">
                ...
                <div style="grid-column: 1 / -1;">
                    <button class="btn-agri" type="submit" style="width:100%;">Add Fertilizer</button>
                </div>
            </form>

        <h2 style="margin-top:20px; color:#224c38;">Fertilizer List</h2>
